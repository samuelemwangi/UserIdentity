...
namespace UserIdentity.Presentation.Controllers.Roles
{
	...
	public class RoleController : BaseController
	{
		...
		{
			var rolesVM = await _getRolesQueryHandler.GetRolesAsync();
		...
		{
			var roleVM = await _getRoleQueryHandler.GetRoleAsync(new GetRoleQuery { RoleId = roleId });
		...
		{
			var userRolesVM = await _getRolesQueryHandler.GetUserRolesAsync(new GetRolesQuery { UserId = userId });

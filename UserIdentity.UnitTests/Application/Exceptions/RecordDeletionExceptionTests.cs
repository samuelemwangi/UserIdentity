...
{
  public class RecordDeletionExceptionTests
  {
    [Fact]
    public async Task Record_Deletion_Error_With_Message_Throws_RecordDeletionException()
    {
      // Arrange
    ...
    [Fact]
    public async Task Record_Deletion_Error_With_Message_and_Classname_Throws_RecordDeletionException()
    {
      // Arrange

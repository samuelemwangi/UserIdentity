...
namespace UserIdentity.UnitTests.Infrastructure.Security
{
    public class JwtTokenHandlerTest : IClassFixture<TestSettingsFixture>
    {
        ...
        {
            JwtTokenHandler tokenHandler = new JwtTokenHandler(_keySetFactory, _logHelper);
        ...
        public void ValidateToken_Validates_Token_For_Valid_Token()
        {
            ...
            String fullToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiaWF0IjoxNTE2MjM5MDIyfQ.5mhBHqs5_DTLdINd9p5m7ZJ6XD0Xc55kIaCRY5r6HRA";
